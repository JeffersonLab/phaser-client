...
/**
 * An immutable page of jobs as returned from a jobs query. The number of records in the page is
 * determined based on the paginator, filter, and actual number in the database.
 *
 * @author ryans
 */
