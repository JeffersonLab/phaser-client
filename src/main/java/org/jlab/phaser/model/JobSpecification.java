 ...
 *
 * This class differs from the JobRecord class. The JobRecord class is an entity representing the
...
public final class JobSpecification {
     ...
     */
    public JobSpecification(boolean correct, boolean continuous, float maxPhaseError,
            float maxMomentumError, int kickSamples, LinkedHashSet<String> cavities) {
