 ...
 *
 * This class represents a row of data from the RESULT table of the Phaser database.
 *
 * @author ryans
 */
public final class ResultRecord {
     ...
     */
    public ResultRecord(BigInteger resultId, Date startDate, Date endDate, Date correctionDate,
            String cavity, Float phase, Float phaseError, PhaserOutcome outcome,
