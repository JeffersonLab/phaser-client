 ...
 *
 * <p>When selecting which cavities to phase, it is often useful to know the last time a cavity had
 * it's phase corrected.
 *
 * @author ryans
 */
public class CavityWithLastCorrection {
  ...
  /**
   * Create a new CavityWithLastCorrection given the cavity name and last correction date.
   *
