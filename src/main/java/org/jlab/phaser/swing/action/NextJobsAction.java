...
/**
 * Handles the "Next" button click on the jobs form. Launches a new JobsWorker to query the Phaser
 * database.
 *
 * @author ryans
 */
public final class NextJobsAction extends AbstractAction {
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    new JobsWorker(
            dialog, new Paginator(0, paginator.getNextOffset(), ResultsDialog.MAX_RECORDS_PER_PAGE))
        .execute();
  }
}
