...
/**
 * Handles the "Resume" button click on the control form. Utilizes the server console to send a
...
public final class ResumeAction extends AbstractAction {
  ...
  private static final Logger LOGGER = Logger.getLogger(ResumeAction.class.getName());
