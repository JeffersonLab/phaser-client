...
/**
 * Prepares the New Job dialog by performing the initial database query to obtain the last phase
 * correction date of cavities.
 *
 * @author ryans
 */
public final class InitializeNewJobDialogWorker
    extends MinimumExecutionSwingWorker<LinkedHashSet<CavityWithLastCorrection>, Void> {

  private static final Logger LOGGER =
      Logger.getLogger(InitializeNewJobDialogWorker.class.getName());
  ...
  protected void done() {
    ...
    try {
      LinkedHashSet<CavityWithLastCorrection> cavityCollection =
          get(); // Get execution result and see if there were any exceptions
