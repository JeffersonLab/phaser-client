...
/**
 * A table model for holding cavities by name and last correction date, and
 * which relies on the view (JTable) to handle dynamic sorting.
 *
 * @author ryans
 */
public class CavityWithLastCorrectionTableModel extends AbstractTableModel {
    ...
    /**
     * Remove all cavities that match the supplied list and return true if data
     * was changed.
     *
    ...
    /**
     * Return the row index that corresponds to the cavity with the specified
     * name.
     *
