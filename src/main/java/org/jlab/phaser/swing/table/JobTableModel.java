...
public class JobTableModel extends AbstractTableModel {
    ...
    private static final List<String> COLUMN_NAMES = Arrays.asList(new String[]{"Job #",
        "Start Date", "<html><center>Duration<br/>(Minutes)</center></html>",
        ...
        switch (column) {
            ...
            case "<html><center>Duration<br/>(Minutes)</center></html>":
                ...
                if (end != null) {
                    ...
                    value = durationFormatter.format((end.getTime() - start.getTime()) / 1000.0
                            / 60.0);
                }
                break;
