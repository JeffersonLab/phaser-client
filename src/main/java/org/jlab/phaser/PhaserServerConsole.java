 ...
 *
 * When a method from this class returns without exception it means that the
 * command was successfully completed and all notifications arising as a result
...
public interface PhaserServerConsole {
    ...
    /**
     * Returns the set of all cavities which are eligible for phasing. The set
     * is ordered alphabetically, which happens to also be S-coordinate order
