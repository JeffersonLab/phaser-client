...
public interface NotificationListener {
     ...
     *
     * Only one status message can be active at any time and this message should replace any
     ...
     *
     * If the job parameter is null then all associated parameters should also be null.
     *
     ...
     */
    public void jobNotification(JobSpecification job, Long jobId, Calendar jobStart,
            Boolean paused, Integer loop, String cavity, Calendar cavityStart,
            Integer progress, String label);
    ...
    /**
     * Notification of current cavity progress (or waiting progress). Progress is an integer between
     * 0 and 100.
     *
