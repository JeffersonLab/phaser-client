...
public class PhaserClientMessageDecoderTest {
    ...
    public void parseAndDispatchNotificationTest() {
        ...
        String serverResponseStr = "{\"name\":\"1L22-3\",\"notification\":\"cavity\",\"start\":\"2023-09-12T10:26:21\"}";
        JsonObject serverResponseJson = Json.createReader(new StringReader(serverResponseStr)).readObject();

        PhaserClientMessageDecoder decoder = new PhaserClientMessageDecoder();

        decoder.addNotificationListener(new NotificationListener() {
            @Override
            ...
            @Override
            public void jobNotification(JobSpecification job, Long jobId, Calendar jobStart, Boolean paused, Integer loop, String cavity, Calendar cavityStart, Integer progress, String label) {
